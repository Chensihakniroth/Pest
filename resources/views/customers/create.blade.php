    ...
    @enderror
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <button type="button" class="btn btn-outline-warning" onclick="GreenHome.resetForm('customerForm', { startDate: '{{ date('Y-m-d') }}', endDate: '{{ date('Y-m-d', strtotime('+1 year')) }}' })">
